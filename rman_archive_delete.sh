...
# scripts can run on various UNIX environments                              ###
...
# If there is more than one ASK user to select correct DB:
elif [ $INS_COUNT -gt 1 ]
 then
    echo
...
# END OF SCRIPT
# #############
# DISCLAIMER: THIS SCRIPT IS USEFUL, BUT WITHOUT ANY WARRANTY. EXECUTE ON YOUR OWN RISK
